...
CREATE TABLE `info` (
  ...
  KEY `user_id` (`user_id`),
  KEY `car_id` (`car_id`),
  CONSTRAINT `info_reference_user_id_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  CONSTRAINT `info_reference_car_id_FK` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`) ON DELETE CASCADE
...
CREATE TABLE `users_roles` (
  ...
  KEY `role_id` (`role_id`),
  CONSTRAINT `users_roles_reference_role_id_FK` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `users_roles_reference_user_id_FK` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT
