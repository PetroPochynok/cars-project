...
<div class="deposit-form">
    <form:form action="saveForm" method="post">
        ...
        <div class="input-group mb-3">
            ...
            <input class="form-control" value="0" type="number" name="money" min="5" max="250000">
            <span class="input-group-text">$</span>
        </div>


        <div class="d-grid gap-2">
            <input class="btn btn-primary" type="submit" value="Submit" onclick="if(!confirm('You confirm?')) return false">
        </div>
