...
<head>
    ...
    <title>Form for add Car to Rent</title>
...
<div style="margin: 25px auto; text-align: center; width: 400px">
    <h2>Form for Add Car to Rent</h2>
    <hr>
</div>

<div class="formForAdd-form">
    <form:form action="saveFormForAddCarToRent" modelAttribute="car" method="post">
        ...
        <div class="d-grid gap-2">
            ...
            <input class="btn btn-secondary" type="button" onclick="window.location.href='/cars/listOfCarsToRentOnSale'" value="Back"/>
        </div>
