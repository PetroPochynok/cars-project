...
<table class="table" style="margin-left: auto; margin-right: auto; width: 60%;" border="1">
    ...
    <c:forEach var="tempInfo" items="${infoList}">
        ...
        <c:url var="changeStatus" value="/info/changeStatus">
        ...
        <tr>
            ...
            <th>${tempInfo.date}</th>
            <th>${tempInfo.paidDays}</th>
            <th>
                <a href="${changeStatus}" class="btn btn-warning btn-sm"  onclick="if (!(confirm('Are you sure you want to change status?'))) return false">Change Status</a>
            </th>
        </tr>
        </tbody>
    </c:forEach>
