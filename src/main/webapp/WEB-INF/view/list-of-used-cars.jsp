...
<table class="table" style="margin-left: auto; margin-right: auto; width: 80%;" border="1">
    ...
    <tr>
        <th>#</th>
        <th><a href="/cars/listOfUsedCarsOnSaleOrderByBrandAsc" style="text-decoration: none">Brand</a></th>
        <th>Model</th>
        <th>Color</th>
        <th><a href="/cars/listOfUsedCarsOnSaleOrderBySeatsDesc" style="text-decoration: none">Seats</a></th>
        <th>Fuel Type</th>
        <th><a href="/cars/listOfUsedCarsOnSaleOrderByMileageAsc" style="text-decoration: none">Mileage</a></th>
        <th><a href="/cars/listOfUsedCarsOnSaleOrderByPriceDesc" style="text-decoration: none">Price</a></th>
        <th>Action</th>
    </tr>
    </thead>
