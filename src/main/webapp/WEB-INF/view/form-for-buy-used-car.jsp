...
<head>
    ...
    <title>Buying Used Car</title>

    <style>
        .formForBuyUsedCar-form {
            width: 400px;
            margin: 0px auto;
        }
        .formForBuyUsedCar-form form {
            margin-bottom: 15px;
            background: #f7f7f7;
...
<div style="margin: 25px auto; text-align: center; width: 700px">
    <h2>Buying Used Car</h2>
    <hr>
</div>

<div class="formForBuyUsedCar-form">
    <form:form action="saveFormForBuyUsedCar" modelAttribute="car" method="post">
        ...
        <div class="d-grid gap-2">
            <input class="btn btn-success" type="submit" value="Buy" onclick="if(!confirm('Are you sure you want to buy this car?')) return false">
