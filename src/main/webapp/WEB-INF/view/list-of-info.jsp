...
<head>
    ...
    <table class="table" style="margin-left: auto; margin-right: auto; width: 60%;" border="1">
        ...
        <c:forEach var="tempInfo" items="${infoList}">
            ...
            <c:url var="deleteInfo" value="/info/deleteInfo">
                <c:param name="infoId" value="${tempInfo.id}"/>
            </c:url>

            <c:url var="showMoreInfo" value="/info/showMoreInfo">
                <c:param name="infoId" value="${tempInfo.id}"/>
            </c:url>
            ...
            <tr>
                ...
                <th>${tempInfo.date}</th>
                <th>
                    <a href="${showMoreInfo}" class="btn btn-primary btn-sm">More Information</a>

                    <a href="${deleteInfo}" class="btn btn-danger btn-sm" onclick="if(!confirm('Are you sure you want to delete this info?')) return false">Delete</a>
                </th>
            </tr>
            </tbody>
        </c:forEach>
