...
<div style="margin: 25px auto; text-align: center; width: 22%">
    <span class="fs-4">Cars to Rent</span>
    <hr>
</div>
...
<table class="table" style="margin-left: auto; margin-right: auto; width: 80%;" border="1">
    ...
    <tr>
        <th>#</th>
        <th><a href="/cars/listOfCarsToRentOnSaleOrderByBrandAsc" style="text-decoration: none">Brand</a></th>
        <th>Model</th>
        <th>Color</th>
        <th><a href="/cars/listOfCarsToRentOnSaleOrderBySeatsDesc" style="text-decoration: none">Seats</a></th>
        <th>Fuel Type</th>
        <th><a href="/cars/listOfCarsToRentOnSaleOrderByMileageAsc" style="text-decoration: none">Mileage</a></th>
        <th>Action</th>
    </tr>
    </thead>
    <c:forEach var="tempCar" items="${cars}">

        <c:url var="updateLink" value="/cars/showFormForUpdateCarToRent">
            <c:param name="carId" value="${tempCar.id}"/>
        </c:url>

        <c:url var="deleteLink" value="/cars/deleteCarToRent">
            <c:param name="carId" value="${tempCar.id}"/>
        </c:url>
