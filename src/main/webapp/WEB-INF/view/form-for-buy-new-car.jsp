...
<head>
    ...
    <title>Buying New Car</title>

    <style>
        .formForBuyNewCar-form {
            width: 400px;
            margin: 0px auto;
        }
        .formForBuyNewCar-form form {
            margin-bottom: 15px;
            background: #f7f7f7;
...
<div style="margin: 25px auto; text-align: center; width: 700px">
    <h2>Buying New Car</h2>
    <hr>
</div>

<div class="formForBuyNewCar-form">
    <form:form action="saveFormForBuyNewCar" modelAttribute="car" method="post">
