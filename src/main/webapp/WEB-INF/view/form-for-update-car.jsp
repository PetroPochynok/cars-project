...
<div class="formForUpdateCar">
    <form:form action="saveFormForUpdateCar" modelAttribute="car" method="post">
        <form:hidden path="id"/>
        ...
        <span style="margin-left: 5px;">Status</span> <form:select path="status" class="form-control">
        <form:option value="NEW CAR ON SALE" >NEW CAR ON SALE</form:option>
        <form:option value="USED CAR ON SALE">USED CAR ON SALE</form:option>
        <form:option value="CAR TO RENT ON SALE">CAR TO RENT ON SALE</form:option>
        <form:option value="BOUGHT CAR">BOUGHT CAR</form:option>
        <form:option value="IN RENT">IN RENT</form:option>
        <form:option value="RETURNED CAR">RETURNED CAR</form:option>
    </form:select>
        <br>
