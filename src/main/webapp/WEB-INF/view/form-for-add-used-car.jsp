...
<head>
    ...
    <title>Form for add Used Car</title>
...
<div style="margin: 25px auto; text-align: center; width: 400px">
    <h2>Form for add Used Car</h2>
    <hr>
</div>

<div class="formForAdd-form">
    <form:form action="saveFormForAddUsedCar" modelAttribute="car" method="post">
        ...
        <div class="d-grid gap-2">
            ...
            <input class="btn btn-secondary" type="button" onclick="window.location.href='/cars/listOfUsedCarsOnSale'" value="Back"/>
        </div>
